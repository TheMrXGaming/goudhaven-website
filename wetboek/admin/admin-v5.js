...
let user=null,chapters=[],articles=[],changes=[],admins=[],articleVersions=[];
...
$("printWetboekButton").onclick=()=>window.open("../?print=1","_blank");
